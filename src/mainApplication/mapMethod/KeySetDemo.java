...
public class KeySetDemo {
	...
	public static void main(String[] args) {
		...
		System.out.println("REQUIREMENT  1 :- only wants the set of key for map entries");
		...
		System.out.println("REQUIREMENT 2  :- only wants the set of key for map entries");
		...
		System.out.println("REQUIREMENT 3 :- only wants the set of key for map entries");
		mapOfEmployee  = null;
		try {
		 ...
		 * 
		 * GIVEN 1 :-map of employee is provided and map is not empty,
		 * REQUIREMENT 1 :- only wants the set of key for map entries
		 * Result set of keys:- [1, 4]
		 * 
		 * GIVEN 2:-if map is empty 
		 * REQUIREMENT 2 :- only wants the set of key for map entries
		 * Result set of keys but it is empty:- []
		 * 
		 * GIVEN 3:-if map is null
		 * REQUIREMENT :- only wants the set of key for map
